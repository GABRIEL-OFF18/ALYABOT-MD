...
// ✅ GLOBAL RCANAL AGREGADO (se puede definir en config.json o global.rcanal en el main)
let rcanal = global.rcanal || 'https://whatsapp.com/channel/0029VbArz9fAO7RGy2915k3O'
  ...
  try {
    ...
    if (fs.existsSync(configPath)) {
      try {
        ...
        if (config.rcanal) rcanal = config.rcanal  // ✅ RCANAL DESDE CONFIG.JSON
      } catch (err) {}
    }
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          sourceUrl: rcanal,  // ✅ AHORA USA EL GLOBAL RCANAL
          mediaType: 1,
